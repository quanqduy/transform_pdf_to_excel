...
def func_main_process(input_list):
    ...
    template_excel = pd.DataFrame(columns=['Số PO', 'STT', 'Ngày phân phối', 'Mã SP 7 số', 'Mã SP 13 số', 'Tên sản phẩm', 'Số lượng', 'Đơn giá', '% Thuế', 'Giá trị sau VAT', 'Hạn sử dụng tối thiểu'])
